...
package com.percentjuice.bulkyLegs.services.assetHandling.loadUnload.loaders.xmlLoading
{
	...
	public class ParseLanguageAsset implements IParseXML
	{
		/* parsed resources */
		public var languageText:Dictionary;

		public function ParseLanguageAsset()
		{
		}
		...
		public function parseAssetsFromXML(bulkLoader:BulkLoader, bulkLoaderKey:String):void
		{
			...
			if (langXML.text.length())
			{
				...
				for each (var prop:XML in langXML.text.*)
				{
					languageText[prop.name()] = String(prop);
				}
			}

			/* once XML is parsed, language XML is irrelevant */
