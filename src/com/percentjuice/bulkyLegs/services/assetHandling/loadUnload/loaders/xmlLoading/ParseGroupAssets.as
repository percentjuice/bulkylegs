...
package com.percentjuice.bulkyLegs.services.assetHandling.loadUnload.loaders.xmlLoading
{
	...
	import com.percentjuice.bulkyLegs.services.assetHandling.loadUnload.loaders.xmlLoading.xmlParsing.GetDataObjectsFromXML;
	...
	public class ParseGroupAssets implements IParseXML
	{
		...
		public function ParseGroupAssets(assetsPath:String)
		{
			super();
		...
		public function parseAssetsFromXML(bulkLoader:BulkLoader, bulkLoaderKey:String):void
		{
			...
			var getData:GetDataObjectsFromXML = new GetDataObjectsFromXML(assetsPath);
