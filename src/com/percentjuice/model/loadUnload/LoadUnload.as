...
package com.percentjuice.model.loadUnload
{
	 ...
	 */
	public class LoadUnload extends ALoad implements IModelUnload 
	{
		/* states for this + Unload + Load, all of which handle multiple asset types */
		public static const INIT:String = 'initializing assets';
		public static const RUNGROUP:String = 'asset loading from group options';
		public static const RUNLANG:String = 'asset loading from lang options';
		...
		override public function loadAsset(assetId:String):void
		{
			...
			if (state == INIT)
			{
				var loadHandler:ILoaderHandler = new Load_InitHandler(new Load_InitLoader());
