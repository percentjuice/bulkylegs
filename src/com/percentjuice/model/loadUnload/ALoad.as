...
package com.percentjuice.model.loadUnload
{
	...
	public class ALoad extends EventDispatcher implements IModelLoad 
	{
		/* errors */
		protected const ERROR_ABSTRACT:String = 'override function in Child class';
		...
		protected function handleGroupLoaded(event:Event):void
		{
			throw new Error(ERROR_ABSTRACT);
		}
